...
INSERT INTO "new_Tache" ("dateEcheance", "description", "id", "priorite", "statut", "titre", "userId") SELECT "dateEcheance", "description", "id", "priorite", "statut", "titre", "userId" FROM "Tache";
DROP TABLE "Tache";
